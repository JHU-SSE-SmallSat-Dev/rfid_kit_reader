...
<mercuryapi-1.37.1.xx\c\baremetal_proj\arduino_proj\Arduino_Mega2560\Read>
...
Please note that "mercuryapi_src.zip" contains C API source files of the Mercury API Version 1.37.1.xx.
